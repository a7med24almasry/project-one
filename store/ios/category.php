...
if (isset($_GET['id'])) {
    ...
    if (!empty($id)) {
        ...
        if ($category_num != 0) {
            ...
            $category_apps = mysqli_query($connect, "SELECT * FROM `application` WHERE `category` = '$category'");
            ...
            $link = 'store/ios/category.php?id=' . $id;
?>
                ...
                <div class="row mt-4">
                    ...
                    if ($category_apps_num != 0) {
                        while ($category_apps_row = mysqli_fetch_array($category_apps)) {
                            $category_apps_title = html_entity_decode($category_apps_row['title_en']);
                    ...
                    ?>
                            <div class="col-lg-2 col-md-3 col-6 app_col" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1500">
                                <a href="ar/store/ios/details.php?id=<?= $category_apps_id ?>">
                                    <div class="app_solid">
